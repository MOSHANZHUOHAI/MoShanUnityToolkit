...
namespace MoShan.Unity.EditorExpand
{
    ...
    /// </summary>
    /// <remarks>
    /// <para/>用于自定义【<see cref="UnityEngine.Transform">变换</see>】组件在【<see cref="global::UnityEditor.InspectorWindow">检视窗口</see>】的显示。
    /// <para/><b>注意：</b>该脚本需要放在【Editor】文件夹下。
    /// </remarks>
    [CanEditMultipleObjects]
    [CustomEditor(typeof(Transform))]
    internal sealed class TransformInspector : OriginalComponentInspector<Transform>
    {
        #region 静态字段
        /// <summary>
        /// 位置复制按钮内容
        ...
        #region 属性
        /// <inheritdoc/>
        protected override string OriginalComponentInspectorTypeFullName
        {
            get
            {
        ...
        protected override void OnEnter()
        {
            ...
            m_IsDisplayExtensionFunction = EditorPrefs.GetBool($"{nameof(TransformInspector)}.{nameof(m_IsDisplayExtensionFunction)}");
        }
        ...
        protected override void OnExit()
        {
            ...
            EditorPrefs.SetBool($"{nameof(TransformInspector)}.{nameof(m_IsDisplayExtensionFunction)}", m_IsDisplayExtensionFunction);
        }
